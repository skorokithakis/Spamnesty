...
DEBUG = True
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'spamnesty.klezy.xyz']
...
if 'test' in sys.argv:
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get("DB_NAME", "spamnesty"),
            'USER': os.environ.get("DB_USER", "spamnesty"),
            'PASSWORD': os.environ.get("DB_PASSWORD", "spamnesty"),
            'HOST': os.environ.get("DB_HOST", ""),
            'PORT': os.environ.get("DB_PORT", 5432),
        }
    }
...
FIXTURES = [BASE_DIR+'/env/apps/mfg/fixtures']

NOTEBOOK_ARGUMENTS = ['--notebook-dir', 'mfg/notebooks']
