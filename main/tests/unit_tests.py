...
class UnitTests(TestCase):
    def test_message_parsing(self):
        messages = [
            ...
            {"sender": "MRS ELIZABETH JOHNSON <elizjohnson@example.com>", "check": "PLEASE YOUR URGENT RESPONSE"},
            {"sender": "SomePerson <sperson@example.com>", "check": "Stuff."},
            {"sender": "SomePerson <sperson@example.com>", "check": "Stuff."},
            ...
            {"sender": "International Thing of Thing Stuff <j.thing@example.com>", "check": "You could try to create"},
            {"sender": "Example <ex@example.com>", "check": "There was stuff"},
            {"sender": "reply.912.45705@example.com", "check": "Do your password reset requests"},
            {"sender": "adminuyuog836 <peyveoext160314@mail.com>", "check": "Message"},
            {"sender": "Bamba Mariam <bamba@gmail.com>", "check": "Things"},
            {"sender": "Rev Fr Andrew Bob <revfatherbob@hotmale.com>", "check": "spam content"},
            {"sender": "John Doe <Ofux@44.34.65.218.broad.nc.jx.dynamic.163data.com.cn>", "check": "More stuff"},
            {"sender": "E. Xample <ex@example.com>", "check": "Hello"},
            {"sender": "E. Xample <ex@example.com>", "check": "Mail here"},
            {"sender": "cj002@tradexunpan.com <cj002@tradexunpan.com>", "check": "Mail body"},
            {"sender": "Ex Ample <ex@example.com>", "check": "Mail body"},
            {"sender": "Yoon Patty (US Partners) <patty.yoon@partners.mcd.com>", "check": "Mail body"},
        ]
